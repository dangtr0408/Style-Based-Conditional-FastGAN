...
class MultiScaleD(nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        for i, (cin, res) in enumerate(zip(self.disc_in_channels, self.disc_in_res)):
            ...
            mini_discs += [str(i), Disc(nc=cin, start_sz=start_sz+minibatch_std_offset, end_sz=8, separable=separable, patch=patch)],
    ...
    def forward(self, features, c):
        ...
        for k, disc in self.mini_discs.items():
            ...
            all_logits.append(out.view(features[k].size(0), -1))
...
class ProjectedDiscriminator(torch.nn.Module):
    ...
    def forward(self, x, c=None):
        ...
        for feature in features.values():
            feature = self.minibatch_std(feature)
        logits = self.discriminator(features, c)#batch n_disc*16
