...
class Generator(nn.Module):
    ...
    def forward(self, input, get_small=False):
...
class Discriminator(nn.Module):
    ...
    def forward(self, imgs, get_aux=False):
        if type(imgs) is not list:
            imgs = [nn.functional.interpolate(imgs, size=self.im_size), nn.functional.interpolate(imgs, size=128)]
        ...
        if get_aux:  
            ...
            return  out, part, [rec_img_big, rec_img_small, rec_img_part]
